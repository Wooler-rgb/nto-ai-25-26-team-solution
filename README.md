...
- Ансамбль из 5 моделей с разными random seed
...
- Обучение 5 моделей: ~15-20 минут (GPU)
...
- Если нет GPU, измените в solution.ipynb параметр `task_type='CPU'`
- Для ускорения можно уменьшить `N_MODELS` до 3 (небольшая потеря качества)
